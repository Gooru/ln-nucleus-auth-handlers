...
public class InitLoginHandler implements DBHandler {
    ...
    if (this.classCode == null || this.classCode.isEmpty()) {
      ...
      return new ExecutionResult<>(
          MessageResponseFactory
              .createInvalidRequestResponse(RESOURCE_BUNDLE.getString("invalid.class.code")),
  ...
  public ExecutionResult<MessageResponse> validateRequest() {
    ...
    if (tenantId == null) {
      ...
      return new ExecutionResult<>(
          MessageResponseFactory
              .createNotFoundResponse(RESOURCE_BUNDLE.getString("class.not.found")),
          ExecutionResult.ExecutionStatus.FAILED);
    }

    this.redirectModel = AJEntityDomainBasedRedirect
        .findFirst(AJEntityDomainBasedRedirect.FIND_BY_TENANT, (UUID) tenantId);
    return new ExecutionResult<>(null, ExecutionStatus.CONTINUE_PROCESSING);
  }
