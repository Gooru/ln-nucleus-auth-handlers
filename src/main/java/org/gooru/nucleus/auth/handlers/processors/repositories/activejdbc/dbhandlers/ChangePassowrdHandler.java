  ...
  public ExecutionResult<MessageResponse> executeRequest() {
    ...
    if (sendEmail) {
      ...
      JsonObject redisPacket =
          new JsonObject().put(AJEntityUsers.EMAIL, user.getString(AJEntityUsers.EMAIL))
              .put(AJEntityUsers.TENANT_ID, user.getString(AJEntityUsers.TENANT_ID));
      this.redisClient.set(newToken, redisPacket.toString(),
          HelperConstants.RESET_PASS_TOKEN_EXPIRY);
      ...
      return new ExecutionResult<>(MessageResponseFactory.createNoContentResponse(
          EventBuilderFactory.getResetPasswordEventBuilder(user.getString(AJEntityUsers.ID),
