...
public class AJUserRepo implements UserRepo {
  ...
  public MessageResponse signupUser() {
    return new TransactionExecutor()
        .executeTransaction(DBHandlerBuilder.buildSignupUserHandler(context));
  }

  @Override
  public MessageResponse updateUser() {
    return new TransactionExecutor()
        .executeTransaction(DBHandlerBuilder.buildUpdateUserHandler(context));
  }

  @Override
  public MessageResponse authorizeUser() {
    return new TransactionExecutor()
        .executeTransaction(DBHandlerBuilder.buildAuthorizeUserHandler(context));
  }
  ...
  public MessageResponse resetPassword() {
    return new TransactionExecutor()
        .executeTransaction(DBHandlerBuilder.buildResetPassowrdHandler(context));
  }
