package org.gooru.nucleus.auth.handlers.processors.repositories.activejdbc.entitybuilders;
...
public interface EntityBuilder<T extends Model> {
  ...
  /*
   * Populate the model from JSON object provided. Note that it does not validate the input with
   * respect to whether the field is allowed, or a field is mandatory to be populated in model but
   * it is not. For that have a look at validators package
   */
