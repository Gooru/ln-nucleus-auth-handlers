...
public final class InternalHelper {
  ...
  public static void executeHTTPClientPost(String data, String authHeader) {
    try {
      ...
      HttpClientRequest eventRequest =
          httpClient.getHttpClient().post(httpClient.endpoint(), responseHandler -> {
      ...
      eventRequest.putHeader(HttpConstants.HEADER_CONTENT_LENGTH,
