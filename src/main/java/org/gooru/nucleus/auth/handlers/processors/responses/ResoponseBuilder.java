...
/**
 * @author szgooru Created On: 03-Feb-2017
 */
public class ResoponseBuilder {
  ...
  public JsonObject build() {
    ...
    tenantJson.put(AJEntityTenant.NAME, tenant.getString(AJEntityTenant.NAME));
    tenantJson.put(AJEntityTenant.SHORT_NAME, tenant.getString(AJEntityTenant.SHORT_NAME));
    tenantJson.put(AJEntityTenant.IMAGE_URL, tenant.getString(AJEntityTenant.IMAGE_URL));
    ...
    result.put(AJEntityUserPreference.PREFERENCE_SETTINGS,
        DBHelper.getUserPreference(userId, tenant.getString(AJEntityTenant.ID)));
    result.put(AJEntityUserRoleMapping.PERMISSIONS_RESP_KEY,
        DBHelper.getUserRolesAndPermission(userId));
