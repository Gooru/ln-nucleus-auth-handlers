...
public class AJEntityRolePermissionMapping extends Model {
  ...
  public final static String FETCH_PERMISSIONS_BY_ROLE =
      "SELECT permission_name FROM role_permission_mapping WHERE role_id = ?";
  public final static String FETCH_PERMISSIONS_BY_MULTIPLE_ROLES =
      "SELECT distinct permission_name FROM role_permission_mapping WHERE role_id = ANY(?::int[])";
